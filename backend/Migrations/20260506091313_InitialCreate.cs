    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventCheckinSessions", x => x.SessionID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasUnlimitedCapacity = table.Column<bool>(type: "boolean", nullable: false),
                    AttendanceMode = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventCheckinSessions_EventID_SessionType_IsActive",
                table: "EventCheckinSessions",
                columns: new[] { "EventID", "SessionType", "IsActive" });
